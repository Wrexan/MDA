...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_2.setMaximumSize(QtCore.QSize(16777215, 14))
        ...
        self.table_right.horizontalHeader().setMinimumSectionSize(14)
        self.table_right.horizontalHeader().setStretchLastSection(True)
        self.table_right.verticalHeader().setVisible(False)
        self.table_right.verticalHeader().setDefaultSectionSize(14)
        self.table_right.verticalHeader().setMinimumSectionSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Пользователь: Вася"))
