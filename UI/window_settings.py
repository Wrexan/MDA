...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        settings_window.resize(597, 561)
    ...
    def retranslateUi(self, settings_window):
        ...
        self.frame_7.setToolTip(_translate("settings_window", "Данные для входа в \"димку\""))
        self.frame_7.setStatusTip(_translate("settings_window", "2"))
        self.frame_7.setWhatsThis(_translate("settings_window", "1"))
