...
class Ui_settings_window(object):
    def setupUi(self, settings_window):
        ...
        settings_window.resize(610, 598)
        ...
        self.horizontalLayout_4.addWidget(self.chb_dk9_caching)
        self.dk9_caching_minutes = QtWidgets.QSpinBox(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dk9_caching_minutes.sizePolicy().hasHeightForWidth())
        self.dk9_caching_minutes.setSizePolicy(sizePolicy)
        self.dk9_caching_minutes.setAlignment(QtCore.Qt.AlignCenter)
        self.dk9_caching_minutes.setMinimum(20)
        self.dk9_caching_minutes.setMaximum(1440)
        self.dk9_caching_minutes.setSingleStep(10)
        self.dk9_caching_minutes.setProperty("value", 30)
        self.dk9_caching_minutes.setObjectName("dk9_caching_minutes")
        self.horizontalLayout_4.addWidget(self.dk9_caching_minutes)
        self.lbl_minutes = QtWidgets.QLabel(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_minutes.sizePolicy().hasHeightForWidth())
        self.lbl_minutes.setSizePolicy(sizePolicy)
        self.lbl_minutes.setObjectName("lbl_minutes")
        self.horizontalLayout_4.addWidget(self.lbl_minutes)
    ...
    def retranslateUi(self, settings_window):
        ...
        self.chb_dk9_caching.setText(_translate("settings_window", "Кешировать веб базу в фоне раз в"))
        self.lbl_minutes.setText(_translate("settings_window", "минут"))
