...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tf_work_name = QtWidgets.QPlainTextEdit(self.frame_9)
        self.tf_work_name.setMinimumSize(QtCore.QSize(0, 26))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.tf_work_name.setFont(font)
        self.tf_work_name.setReadOnly(True)
        self.tf_work_name.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.tf_work_name.setObjectName("tf_work_name")
        self.verticalLayout_9.addWidget(self.tf_work_name)
        self.tf_work_descr = QtWidgets.QPlainTextEdit(self.frame_9)
        self.tf_work_descr.setMinimumSize(QtCore.QSize(0, 26))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.tf_work_descr.setFont(font)
        self.tf_work_descr.setReadOnly(True)
        self.tf_work_descr.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.tf_work_descr.setObjectName("tf_work_descr")
        self.verticalLayout_9.addWidget(self.tf_work_descr)
        self.tf_work_price = QtWidgets.QPlainTextEdit(self.frame_9)
        self.tf_work_price.setMinimumSize(QtCore.QSize(0, 26))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.tf_work_price.setFont(font)
        self.tf_work_price.setReadOnly(True)
        self.tf_work_price.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.tf_work_price.setObjectName("tf_work_price")
        self.verticalLayout_9.addWidget(self.tf_work_price)
        ...
        self.chb_search_narrow = QtWidgets.QCheckBox(self.frame_4)
        ...
        self.chb_price_name_only = QtWidgets.QCheckBox(self.frame_4)
        ...
        self.input_search.setMinimumSize(QtCore.QSize(460, 30))
        self.input_search.setMaximumSize(QtCore.QSize(460, 30))
        self.input_search.setBaseSize(QtCore.QSize(460, 30))
        font = QtGui.QFont()
        ...
        self.pb_adv_search = QtWidgets.QPushButton(self.frame_5)
        self.pb_adv_search.setEnabled(False)
        self.pb_adv_search.setMaximumSize(QtCore.QSize(120, 16777215))
        self.pb_adv_search.setSizeIncrement(QtCore.QSize(120, 0))
        ...
        self.horizontalLayout_6.addWidget(self.pb_adv_search)
        self.pb_show_list = QtWidgets.QPushButton(self.frame_5)
        self.pb_show_list.setEnabled(False)
        self.pb_show_list.setMaximumSize(QtCore.QSize(120, 16777215))
        self.pb_show_list.setSizeIncrement(QtCore.QSize(120, 0))
        self.pb_show_list.setAutoDefault(False)
        self.pb_show_list.setDefault(False)
        self.pb_show_list.setFlat(False)
        self.pb_show_list.setObjectName("pb_show_list")
        self.horizontalLayout_6.addWidget(self.pb_show_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chb_search_smart.setText(_translate("MainWindow", "Фильтр"))
        self.chb_search_narrow.setText(_translate("MainWindow", "Минимум 2"))
        self.chb_search_eng.setText(_translate("MainWindow", "Латиница"))
        self.chb_price_name_only.setText(_translate("MainWindow", "Строго"))
        self.input_search.setPlaceholderText(_translate("MainWindow", "Введите модель"))
        self.pb_adv_search.setText(_translate("MainWindow", "Расшир. поиск"))
        self.pb_show_list.setText(_translate("MainWindow", "Показать лист"))
